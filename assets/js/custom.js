  ...
  /* ----------------------------------------------------------- */
   ...
   /*jQuery(window).ready(function(){
      if(jQuery(this).width()>600){
        jQuery('.reservation-btn-normal').removeAttr("style");
        jQuery('.reservation-btn-responsive').attr("style","display:none");
      }else{
        jQuery('.reservation-btn-normal').attr("style","display:none");
        jQuery('.reservation-btn-responsive').removeAttr("style");
      }
   })*/
